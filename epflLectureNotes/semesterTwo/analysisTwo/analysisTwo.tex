...
In this case, we have that although the partial derivative exists its existance does not imply continuity. The partial derivative itself must be continuous to imply continuity. 
\end{example}
