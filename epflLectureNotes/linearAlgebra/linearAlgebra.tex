...
\begin{definition}
Let $u,v \in \Rn$ Then we define the inner product of $u$ and $v$ as the matrix multiplication $u^{T}v$ such that $$u^{T}v = \begin{bmatrix}
    u_{1} \ldots u_{n}
\end{bmatrix}\begin{bmatrix}
    v_{1}\\
    \vdots\\
...
\begin{proof}
$$v \cdot u_{i} = (c_{1}u_{1} + \ldots + c_{n}u_{n})u_{i} = c_{i}(u_{i}\cdotu_{i}$$
\end{proof}
